...
<div aria-labelledby="myModalLabel" role="dialog" tabindex="-1" id="view_npc" class="modal fade">
    <div class="modal-dialog modal-lg">
        <div class="modal-content" >
            <div class="modal-header" style="background-color: #00264d">
                <h5 class="modal-title" style="font-size: 25px; color: white; text-align: center ">DPA Statement in Data Collection
            ...
            <div class="modal-body" style="height:auto; ">
                ...
                <div class="col-md-12" style="text-align: center; margin-bottom: 10px; color: black">
                    <img src="resources-web/images/rop-npc.png" style="width:35%" alt="">
                ...
                <div class="col-md-12">
                    ...
                    <div style="text-align: center;">
                        <button class="btn btn-success" data-dismiss="modal" style="background-color: green">
                            <i class="fa fa-check"></i> Ok, I understand.
                        </button>
                    </div>
                </div>
