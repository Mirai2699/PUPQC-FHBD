<?php
    $view_query = mysqli_query($connection,"SELECT * FROM `r_office`");
                    ...
                    <div class="col-md-12">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label style="font-size: 17px"><b>Office Name:</b></label>
                                    <input type="text" class="form-control" name="office_name" value="<?php echo $office_name ?>" required/>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-12">
                            ...
                            <div class="col-md-12" style="text-align: center">
                                <button type="submit" class="btn btn-success" name="edit_office">
            ...
            <div class="modal-body" style="">
                <form role="form" method="POST" action="../functionalities/archive_func.php">
                    <div class="col-md-12">
                            ...
                            <div class="col-md-12" style="text-align: center">
                                <button type="submit" class="btn btn-success" name="archive_office">
