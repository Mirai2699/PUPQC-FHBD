                    ...
                    <div class="col-md-12">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label style="font-size: 17px"><b>Source Type Description:</b></label>
                                    <input type="text" class="form-control" name="src_name" value="<?php echo $srctype_name ?>" required/>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-12">
                            ...
                            <div class="col-md-12" style="text-align: center">
                                <button type="submit" class="btn btn-success" name="edit_src">
            ...
            <div class="modal-body" style="">
                <form role="form" method="POST" action="../functionalities/archive_func.php">
                    <div class="col-md-12">
                            ...
                            <div class="col-md-12" style="text-align: center">
                                <button type="submit" class="btn btn-success" name="archive_src">
